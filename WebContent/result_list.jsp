...
<body>
    ...
    <ul class="disklist">
 	<%
	  if(treeNum!=0){
		  out.print("<li><a href='DownloadHandle?type=result'>");
		  out.print("<div class='dleftexcel'></div><div class='dright'><h3>");
	      out.print("result.xls");
	      out.print("</h3><p>office表格</p></div></a></li>");
	  }
	%>
	</ul>
</body>
