...
<body>
    ...
    <div class="formbody">
      <div class="formtitle"><span>数据集</span></div>    
    	<ul class="forminfo">
    	<form action="UploadHandle?type=data" method="post" enctype="multipart/form-data">
    	<li><label>数据名称</label><input name="" type="text" class="dfinput" value="TrainingData" /><i>标题不能超过30个字符</i></li>
